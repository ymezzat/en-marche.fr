...
class CitizenInitiativeMessageNotifier implements EventSubscriberInterface
{
    ...
    private function createMessageToOrganizer(Adherent $organizer, CitizenInitiative $initiative)
    {
        return CitizenInitiativeOrganizerValidationMessage::create($organizer, $initiative);
    }
